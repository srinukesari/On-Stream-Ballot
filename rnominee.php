...
<div class="div21" style="width:100%;height:92%;background-color:transparent;position:relative;">
	<div class="div2" style="width:17%;height:100%;background-color:Azure;position:absolute; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
		...
		<p style="padding-top:10px;"><a href="nremove.php" class="button"><i class="fa fa-pie-chart" style="float:left;";> remove nominee</i></a></p>
		<p style="padding-top:10px;"><a href="nlist.php" class="button"><i class="fa fa-pie-chart" style="float:left;";>Nominee list</i></a></p>
		<p style="padding-top:10px;"><a href="table.php" class="button"><i class="fa fa-pie-chart" style="float:left;";> status</i></a></p>
	</div>
	<div class="div3" style="left:17%;height:98%;width:83%;padding:30px 320px;background-color:transparent;position:absolute;">
		<div class="div31" style="left:5%;height:90%;width:83%;padding:30px 320px;background-color:transparent;position:absolute;">
				...
				<center><p style="font-size:20px;">Add Voter<br><br></p></center>
				<form method="Post" action="addvotersql.php">
				<center><input type="text" placeholder="voter-name" name="vname" required>
				<input type="text" placeholder="voter-id" name="vid" required>
				<input type="date" placeholder="DOB" name="vdob" required>
				<input type="email" placeholder="voter-email" name="vemail" required></center>
				<br>
				<br>
				<p style="padding-left:185px;" ><input type="submit" name="ADD" class="button1"></p>
				</form>
		</div>
	</div>
</div>
