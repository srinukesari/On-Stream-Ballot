...
<div class="div21" style="width:100%;height:92%;background-color:transparent;position:relative;">
	...
	<div class="div3" style="left:17%;height:98%;width:83%;padding:30px 200px;background-color:transparent;position:absolute;overflow:auto;">
		<center><h1><i class="fa fa-yelp" style="font-size:40px;color:red;";><font color="#3369E8">B</font><font color="#D50F25">a</font><font color="#EEB211">l</font><font color="#3369E8">l</font><font color="#009925">o</font><font color="#D50F25">t</font></i></h1></center>
				<center><p style="font-size:20px;">Voter List<br><br></p></center>
			<?php
					...
					$result1 = mysqli_query($conn,"SELECT * FROM voter");
					$result2 = mysqli_query($conn,"SELECT * FROM voterdetails");
					...
					while($row1 = mysqli_fetch_array($result1))
					{
						...
						echo "<tr>";
						echo "<td>" . $row1['vids'] . "   </td>";
						echo "<td>" . $row1['vname'] . "  </td>";
						echo "<td>" . $row2['vemail'] . "  </td>";
						echo "<td>" . $row2['vdob'] . "   </td>";
						echo "</tr>";
					}
					echo "</table>";
