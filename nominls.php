...
<div class="id1" style="margin:100px 520px;width:350px;height:65%;padding:12px 15px;background-color:white; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
	...
	<div class="btn-group btn-group-justified">
		...
		<a href="nominls2.php" class="btn btn-default">SIGNUP</a>
	</div>
	<br>
	<form method="post" action="nominlssql.php">
	<center><input type="text" placeholder="Candidate Id" name="cid" required>
	<input type="password" placeholder="PASSWORD" name="pass" required></center>
	<br>
	<br>
	<br>
	<p style="padding-left:220px;"><input  type="submit" name="login" value="login" class="button"></p>
	</form>
</body>
</html>
