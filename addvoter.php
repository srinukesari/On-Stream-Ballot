...
<?php
			...
			$age = (date('Y') - date('Y',strtotime($vdob)));
			...
			if($age>=18){
				if(strlen($vid) == 12){
					if(mysqli_query($conn, $sql)===true){
						...
						echo "<script type='text/javascript'>confirm('voter id or email is alreday registered');</script>";
						}
					}
					else{
						echo "<script type='text/javascript'>confirm('voter id or email is alreday registered');</script>";
					...
					echo "<script type='text/javascript'>confirm('voter id not valid.it should contain 12 digits');</script>";
				}
			}
			else{
				echo "<script type='text/javascript'>confirm('voter should be 18 years above');</script>";
			}
			}
?>